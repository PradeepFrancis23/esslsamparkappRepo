...
class AppConfig {
  ...
  static final String APP_STORE_URL =
      "https://apps.apple.com/us/app/eesl-sampark/id1576668992";
  static final String PLAY_STORE_URL =
      "https://play.google.com/store/apps/details?id=com.eeslsampark.app";
  // Dashboard URLs
  ...
  static final String EXEL_DOWNLOAD_LINK =
      "https://support.eeslindia.org/api/AppExcelDownload/";
  ...
  // static final String API_LINK =
  //     "http://staging.fivesdigital.com/api/commonapi/";
  // static final String API_LINK =
  //     "http://staging.fivesdigital.com:8082/api/commonapi/";
  static final String API_LINK = "https://support.eeslindia.org/api/commonapi/";
  //static final String API_LINK =
  //"https://staging.fivesdigital.com/api/commonapi/";
  ...
  static final String API_GET_STATE =
      API_LINK + "GetSchemeWiseStateList?Schemeid=";
  static final String API_GET_STATE_WISE_DISTRICT =
      API_LINK + "GetStateSchemeWiseDistrictList?Schemeid=";
  // getComplaint Status
  static final String GET_COMPLAINT_STATUS =
      API_LINK + "GetComplaintStatus?IDmobile=";
  static final String GET_TOP_COMPLAINT_STATUS =
      API_LINK + "GetTopComplaints?MobileNo=";
  // lodge Complaint
  static final String CONSUMER_ENTRY = API_LINK + "ConsumerEntry";
  // Street Light
  static final String API_GET_ULB_LIST =
      API_LINK + "GetStreetLightULBList?DistrictId=";
  static final String API_GET_ZONE_LIST =
      API_LINK + "GetStreetLightZoneList?ULBID=";
  ...
  static final String GET_REASON_OF_COMPLAINT_LIST =
      API_LINK + "GetUjalaComplainTypeList";
  // Agdcm
  static final String GET_REASON_COMPLAINT_LIST =
      API_LINK + "GetReasonOfComplaintList";
  static final String GET_SOUL_BLOCK_LIST = API_LINK + "SoulBlockList?Stateid=";
  // AjayPhase
  static final String AJAYONE_CONSTITUENCY_LIST =
      API_LINK + "AjayOneConstituencyList?Stateid=";
  static final String AJAY_TWO_CONSTITUENCY_LIST =
      API_LINK + "AjayTwoConstituencyList?Stateid=";
  static final String AJAY_COMPLAINT_CATEGORYLIST =
      API_LINK + "AjayOneComplaintCategoryList";
  // Solus
  static final String GET_ADC_MASTER_DATA =
      API_LINK + "GetADCMasterData?Blockid=";
  static final String GET_RM_CODE_ONLOAD =
      API_LINK + "GetRMCODEOnLoad?Blockid=";
  static final String GET_RM_CODE_NAME_ONLOAD =
      API_LINK + "GetRMCODENameOnLoad?Blockid=";
  static final String GET_RM_CENTER_MASTER =
      API_LINK + "GetRMCenterMaster?RMCode=";
  // Railway
  static final String GET_BEEP_RAILWAYZONE_LIST =
      API_LINK + "GetBeepRailwayZoneList?Stateid=";
  static final String GET_BEEP_DIVISION_LIST =
      API_LINK + "GetBeepRailwayDivisionList?Stateid=";
  static final String GET_BEEP_STATION_LIST =
      API_LINK + "GetBeepRailwayStationList?Stateid=";
  static final String GET_BEEP_PRODUCT_CATEGORY_LIST =
      API_LINK + "GetBeepProductCategoryListForProductMapping?Zoneid=";

  static final String GET_BEEP_PRODUCT_CATEGORY_ITEM_LIST =
      API_LINK + "GetBeepProductCategoryItemList?Stateid=";

  static final String GET_PRODUCT_WATT_LIST =
      API_LINK + "GetProductWattList?ProductId=";
  static final String GET_PRODUCT_MOUNTING_LIST =
      API_LINK + "GetProductMountingList?ProductId=";
  static final String GET_PRODUCT_MANUFACTURER_LIST =
      API_LINK + "GetProductManufacturerListCaller?Stateid=";
  //AC
  static final String GET_AC_ISSUE_TYPE_LIST = API_LINK + "GetACIssuTypeList";
  //Building
  static final String GET_BUILDING_PRODUCT_TYPE =
      API_LINK + "GetBuildingProductType";
  ...
  //B2B API
  static final String VALIDATE_B2B_CODE =
      API_LINK + "ValidateB2BCode?CodeNumber=";
  ...
  static final String ADD_SCHEME_B2B_USER_PROFILE =
      API_LINK + "AddSchemsInB2BProfile";

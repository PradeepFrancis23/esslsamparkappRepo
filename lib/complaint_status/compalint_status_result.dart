...
class ComplainStatus extends StatefulWidget {
   ...
   String  complaintId;
  ComplainStatus(this.complaintId);

  @override
  _ComplainStatusState createState() => _ComplainStatusState(complaintId);
}
...
class _ComplainStatusState extends State<ComplainStatus> {
  ...
  String complaintId;
  _ComplainStatusState(this.complaintId);

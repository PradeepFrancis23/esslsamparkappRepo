...
import 'package:eeslsamparkapp/lodge_complaint/building_scheme.dart';
import 'package:eeslsamparkapp/lodge_complaint/other_scheme.dart';
import 'package:eeslsamparkapp/lodge_complaint/railway_scheme.dart';
import 'package:eeslsamparkapp/lodge_complaint/show_image.dart';
...
class _LodgeComplaintScreenState extends State<LodgeComplaint>
                  ...
                  items: scheme_list.map(
                    (SchemeListGS response) {
                      return DropdownMenuItem<SchemeListGS>(
                          value: response, child: Text(response.schemeName));
                    },
                  ).toList(),
                          ...
                          child: DropdownButton(
                            ...
                            hint: light_type == null
                                ? Padding(
                                    ...
                                    child: Text('Select Light Type',
                                        style: TextStyle(
                                            color: Colors.grey, fontSize: 17)))
                                : Padding(
                                    padding:
                                        EdgeInsets.only(left: 5, right: 10),
                                    child: Text(light_type,
                                        style: TextStyle(color: Colors.black))),
                            isExpanded: true,
                            iconSize: 30.0,
                            style: TextStyle(color: Colors.black),
                            items: light_type_list.map(
                              (String response) {
                                return DropdownMenuItem<String>(
                                    value: response, child: Text(response));
                              },
                            ).toList(),
                  ...
                  items: state_list.map(
                    (StateResponse response) {
                      return DropdownMenuItem<StateResponse>(
                          value: response, child: Text(response.text));
                    },
                  ).toList(),
            ...
            Center(
              child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    switch (scheme_id) {
                      case 1:
                        if (txt_number.text.length != 10 ||
                            txt_number.text.startsWith(RegExp(r'[0-5]'))) {
                          Fluttertoast.showToast(
                          ...
                          Fluttertoast.showToast(
                              msg: "We don't take NON_LED complaint");
                        } else {
                          if (buttonText == null) {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (BuildContext context) =>
                                    StreetLightScheme(
                                        ...
                                        txt_number.text,
                                        txt_name.text,
                                        txt_street_light_address.text,
                                        txt_street_light_landmark.text,
                                        state!,
                                        district!,
                                        "")));
                          } else {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (BuildContext context) =>
                                    StreetLightScheme(
                                        ...
                                        state!,
                                        district!,
                                        AppConfig.encodeImage(imageFile!))));
                          }
                        }
                        break;
                      ...
                      case 2:
                        if (txt_number.text.length != 10 ||
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (BuildContext context) => UjalaScheme(
                                  scheme_id!,
                                  state_id!,
                                  district_id!,
                                  txt_number.text,
                                  txt_name.text,
                                  txt_ujala_address.text,
                                  txt_ujala_landmark.text,
                                  state!,
                                  district!)));
                        }
                      ...
                      case 3:
                        if (txt_number.text.length != 10 ||
                          ...
                          Fluttertoast.showToast(
                              msg:
                                  "Please enter USC No. or Service Connection no");
                        } else {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (BuildContext context) => AgdcmScheme(
                                  scheme_id!,
                                  state_id!,
                                  district_id!,
                                  txt_number.text,
                                  txt_name.text,
                                  txt_usc.text,
                                  txt_panel_board.text,
                                  txt_usc_address.text,
                                  txt_usc_landmark.text,
                                  state!,
                                  district!)));
                        }
                      ...
                      case 5:
                        if (txt_number.text.length != 10 ||
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (BuildContext context) => OtherScheme(
                                  scheme_id!,
                                  state_id!,
                                  district_id!,
                                  txt_number.text,
                                  txt_name.text,
                                  txt_other_address.text,
                                  txt_other_landmark.text,
                                  state!,
                                  district!)));
                        }
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (BuildContext context) =>
                                  AjayPhaseScheme(
                                      ...
                                      txt_name.text,
                                      txt_pole_id.text,
                                      txt_pole_address.text,
                                      txt_pole_landmark.text,
                                      state!,
                                      district!)));
                        }
                        break;
                      ...
                      case 7:
                        if (txt_number.text.length != 10 ||
                          ...
                          if (emailValid) {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (BuildContext context) => AcScheme(
                                    scheme_id!,
                                    state_id!,
                                    district_id!,
                                    txt_number.text,
                      ...
                      case 10:
                        if (txt_number.text.length != 10 ||
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (BuildContext context) => SolusScheme(
                                  scheme_id!,
                                  state_id!,
                                  district_id!,
                                  txt_number.text,
                                  txt_name.text,
                                  txt_soulus_address.text,
                                  txt_soulus_landmark.text,
                                  state!,
                                  district!)));
                        }
                      ...
                      case 11:
                        if (txt_number.text.length != 10 ||
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (BuildContext context) => BeepScheme(
                                  scheme_id!,
                                  state_id!,
                                  district_id!,
                                  txt_number.text,
                      ...
                      default:
                        Fluttertoast.showToast(
                            msg: "Please Select Scheme First");
                        break;
                    }
                  },
        ...
        _widget = Column(
          ...
          children: [
            ...
            Container(
                margin: EdgeInsets.only(left: 10, right: 10, top: 10),
                child: TextFormField(
                    controller: txt_soulus_landmark,
                    textCapitalization: TextCapitalization.characters,
                    decoration: InputDecoration(
                        hintText: 'Landmark',
                        counter: Container(),
  ...
  getLoginDetails() async {
    ...
    setState(() {
      ...
      txt_street_light_address.text =
          _sharedPreferences!.getString(AppConfig.ADDRESS)!;
      txt_ujala_address.text =
          _sharedPreferences!.getString(AppConfig.ADDRESS)!;
      txt_usc_address.text = _sharedPreferences!.getString(AppConfig.ADDRESS)!;
      txt_buliding_address.text =
          _sharedPreferences!.getString(AppConfig.ADDRESS)!;
      txt_other_address.text =
          _sharedPreferences!.getString(AppConfig.ADDRESS)!;
    ...
    _sharedPreferences?.getString(AppConfig.USER_TYPE) == "B2B-USER"
        ? ""
        : _getSchemeList();
    _sharedPreferences?.getString(AppConfig.USER_TYPE) == "B2B-USER"
        ? ""
        : _getAllState(scheme_id!);
  ...
  _getSchemeList() async {
    ...
    var response =
        await http.Client().get(Uri.parse(AppConfig.GET_SCHEME_LIST), headers: {
      "Accept": "application/json",
      'Authorization':
          'Bearer ${_sharedPreferences?.getString(AppConfig.TOKEN)}'
    });
    print(response.body);
    setState(() {
  ...
  _getAllState(int id) async {
    ...
    var response = await http.Client()
        .get(Uri.parse("${AppConfig.API_GET_STATE}$id"), headers: {
      "Accept": "application/json",
      'Authorization':
          'Bearer ${_sharedPreferences?.getString(AppConfig.TOKEN)}'
    });
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text("We don't take NON-LED complaint ",

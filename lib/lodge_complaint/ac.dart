...
class _ACschemeState extends State<AcScheme> {
  ...
  late int selectedAcDetails = 0;
  late int selectedUnit = 0;
  late final date_format = DateFormat("dd-MM-yyyy");

  late String issue_type;
  late int issue_id;
  late List<StateResponse> issue_type_list =[];

  late bool is_order = true;
  late bool is_register_mobile = false;
  late bool is_serial_no = false;
  late bool is_ac_not_install = false;
  late bool is_refund_issue = false;
  late bool is_other_issue = false;

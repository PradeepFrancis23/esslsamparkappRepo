...
class _AjayPhaseSchemeState extends State<AjayPhaseScheme> {
  ...
  late int constituency_id;
  late final List<StateResponse> constituency_list = [];

  late  String category_type;
  late int category_type_id;
  late final List<StateResponse> category_type_list = [];
                    ...
                    if(constituency_id == null) {
                      ...
                      AppConfig.getUserLocation(context).then((currentPostion) {
                        if (currentPostion != null) {
                          ...
                          if(scheme_id == 6) {
                            _registerComplaintOne(lat, long);
                          } else {
                            _registerComplaintTwo(lat, long);
                          }
                        } else {
                          showDialog(
                              context: context,

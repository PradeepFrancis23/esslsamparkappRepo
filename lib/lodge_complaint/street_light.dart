...
class _StreetLightSchemeState extends State<StreetLightScheme> {
  ...
  late String ulb;
  late int ulb_id;
  late final List<ULBResponse> ulb_list = [];

  late String? zone;
  late int zone_id;
  late  final List<ZoneResponse> zone_list = [];

  late String? area_type;
  late int area_id;
  late final List<StateResponse> area_type_list = [];

  late String? ticket_type;
  late int ticket_id;
  late final List<StateResponse> ticket_type_list = [];
                    ...
                    if(ulb == null) {
                      ...
                      AppConfig.getUserLocation(context).then((currentPostion) {
                        if (currentPostion != null) {
                          ...
                          _registerComplaint(txt_ward.text, txt_pole_no.text, txt_remark.text,lat,long);

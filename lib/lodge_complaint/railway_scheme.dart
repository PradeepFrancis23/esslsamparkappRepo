...
class _RailwaySchemeState extends State<RailwayScheme> {
  ...
  late String? railway_zone;
  late int? railway_zone_id;
  late final List<StateResponse> railway_zone_list = [];

  late String? railway_div;
  late int? railway_div_id;
  late final List<StateResponse> railway_div_list = [];

  late String? railway_station;
  late int? railway_station_id;
  late final List<StateResponse> railway_station_list = [];

  late String? product_category;
  late int? product_category_id;
  late final List<StateResponse> product_category_list = [];

  late String? product;
  late int? product_id;
  late final List<StateResponse> product_list = [];

  late String? watt;
  late int?  watt_id;
  late final List<StateResponse> watt_list = [];

  late String? mounting;
  late int? mounting_id;
  late final List<StateResponse> mounting_list = [];


  late String? manufacturer;
  late int? manufacturer_id;
  late final List<StateResponse> manufacturer_list = [];

  late String? dimension;
  late final List<String> dimension_list = [];

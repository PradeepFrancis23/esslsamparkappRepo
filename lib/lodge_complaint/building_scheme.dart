...
class _BuildingSchemeState extends State<BuildingScheme> {
  ...
  late String buliding;
  late int buliding_id;
  late final List<StateResponse> buliding_list = [];

  late SharedPreferences _sharedPreferences;
  late ArsProgressDialog _progressDialog;

  late List<bool> _isChecked;
  late final List<ProductResponse> product_list = [];
                      ...
                      if(product_type_id.length != 0) {
                        ...
                        AppConfig.getUserLocation(context).then((currentPostion) {
                          if (currentPostion != null) {
                            ...
                            _registerComplaint(lat,long,product_type_qty,product_type_id, led_id,ac_id);

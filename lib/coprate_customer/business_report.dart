...
class _BusinessReportScreenState extends State<BusinessReportScreen> {
  ...
  late ArsProgressDialog _progressDialog2;
  ...
  _getSchemeList() async {
    ...
    var response = await http.Client().get(Uri.parse(AppConfig.GET_SCHEMES + _sharedPreferences.getString(AppConfig.B2BCode_Id).toString()),
                  ...
                  onPressed: () async {
                    ...
                    if(scheme_id == null) {
                      ...
                      if(isPermissionStatusGranted) {
                        _getReport(txt_start_date.text, txt_end_date.text, scheme!, _sharedPreferences.getString(AppConfig.MOBILE_USER_ID).toString());
                      } else {

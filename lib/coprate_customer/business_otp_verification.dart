...
class BusinessOTPVerificationScreen extends StatefulWidget {
  ...
  @override
  _BusinessOTPVerificationScreenState createState() =>
      _BusinessOTPVerificationScreenState(mobile_no, unique_code);
}

class _BusinessOTPVerificationScreenState
    extends State<BusinessOTPVerificationScreen> {
              ...
              child: ElevatedButton(
                  ...
                  onPressed: () {
                    if (currentText.length == 4) {
                      ...
                      _validateOTP(
                          mobile_no, currentText, unique_code.toUpperCase());
                    } else {
                  ...
                  style: ElevatedButton.styleFrom(
                      ...
                      textStyle: TextStyle(
                          fontSize: 18, fontFamily: AppConfig.FONT_TYPE_BOLD))),
            ),
            Container(
  ...
  _validateOTP(String mobile_no, String otp, String unique_code) async {
    ...
    String url =
        "${AppConfig.VALIDATE_OTP_B2B_USER + "?OTPNumber=$otp&mobileno=$mobile_no&code=$unique_code"}";
    ...
    if (jsonData['responseCode'] == AppConfig.SUCESS_CODE) {
      ...
      Navigator.of(context).push(MaterialPageRoute(
          builder: (BuildContext context) =>
              BusinessRegistration(B2BCodeId.toString())));
    } else {
